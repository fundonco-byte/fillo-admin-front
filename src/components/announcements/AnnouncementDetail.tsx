      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              {announcement.isVisible ? (
                ...
                <span className="inline-flex items-center gap-1 px-3 py-1 text-sm font-semibold bg-red-100 text-red-800 rounded-full">
        ...
        <div className="p-6">
          ...
          {announcement.mediaFiles.length > 0 && (
            <div className="mb-6">
              ...
              <div className="space-y-2">
                {announcement.mediaFiles.map((file, index) => (
                  <div
                    key={index}
          ...
          <div className="border-t border-gray-200 pt-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">정보</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-sm font-medium text-gray-600 mb-1">
                  공지사항 ID
                </div>
                <div className="text-gray-800">{announcement.id}</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-sm font-medium text-gray-600 mb-1">
                  노출 상태
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-gray-800">{announcement.createdAt}</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-sm font-medium text-gray-600 mb-1">
                  최종 수정 일시
                </div>
                <div className="text-gray-800">{announcement.updatedAt}</div>
              </div>
            </div>
          </div>
        </div>
